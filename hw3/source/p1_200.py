...
def generate_spd_matrix(n):
    ...
    for i in range(n):
        A[i][i] += n*5  # Ensure diagonal dominance for positive definiteness
    return A
...
for _ in range(num_trials):
    ...
    for precond_type in precond_types:
        ...
        plt.savefig(f"/Users/kevin_smith/Desktop/FSU_Relevant_Stuff/fall_2023/FCM1/homework/programming/hw3/figures/n200/residual_norms_sd_{precond_type}.png")
        plt.close()
        plt.figure()
        ...
        plt.xlabel("Iteration")
        plt.ylabel("Residual Norm")
        plt.savefig(f"/Users/kevin_smith/Desktop/FSU_Relevant_Stuff/fall_2023/FCM1/homework/programming/hw3/figures/n200/residual_norms_cg_{precond_type}.png")
        plt.close()
...
df.to_csv("/Users/kevin_smith/Desktop/FSU_Relevant_Stuff/fall_2023/FCM1/homework/programming/hw3/data/n200.csv", index=False)
